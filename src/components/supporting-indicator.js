...
const SupportingIndicator = ({ data }) => {
  const renderIndicatorType = (data) => {
    switch (data.type) {
      case "stat":
  ...
  return (
    <div
      className={`supporting-indicator ${
        data.type === "stat" ? "supporting-indicator__stat" : ""
      }`}
    >
